...
let firstSix = quote.slice(0, 5);

for (i of firstSix) {
  console.log(`The character at index ${firstSix.indexOf(i)} is '${i}'`);
}
...
"".concat(from, " ", quote, " ", to);

/*
6. Does from, to and quote ends with "rk". Check all three.
*/
[from, quote, to].every((x) => x.endsWith("rk"));
...
quoteSplitted.splice(indexOfToday, 1, "tomorrow");
quoteSplitted.join(" ");

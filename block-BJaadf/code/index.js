...
if (fruits.findIndex("Dragon Fruit") == 0 && fruits.findIndex("Guava") == 1) {
  return true;
} else {
  return false;
}
...
numbersThree.forEach((x) => console.log(x));
...
let oddNumbers = numbersThree.filter((x) => x % 2 !== 0);

// Create a new variable named evenNumbers that store all the even numbers in numbersThree array
let evenNumbers = numbersThree.filter((x) => x % 2 == 0);

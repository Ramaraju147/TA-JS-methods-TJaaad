...
let halfNumbers = numbersThree.map( ( num ) => num * ( 1 / 2 ) );
...
numbersThree.reverse( compareFunction );

// Reverse the values of numbersTwo array
numbersTwo.reverse( compareFunction );
